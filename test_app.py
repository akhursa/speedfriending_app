...
def test_event_state(join_code: str):
    ...
    try:
        ...
        assert state["participants_count"] == 5, (
            f"Expected 5 participants, got {state['participants_count']}"
        )
...
def test_event_info(join_code: str):
    ...
    try:
        ...
        assert info["participant_count"] == 5, (
            f"Expected 5 participants, got {info['participant_count']}"
        )
...
if join_code:
    ...
    # Test 21: Break phase next partner photo
